...
helm.sh/chart: {{ include "eureka-server.chart" . }}
...
*/}}
{{- define "eureka-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "eureka-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
